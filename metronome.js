...
let soundon = document.querySelector("#audioswitch");
...
function beep({ dobeep = true } = {}) {
  ...
  osc.frequency.value = soundon.checked ? 700 : 0;
  let defgain = 0.5;
...
function vbeep() {
  visualbeep.classList.add("beep");
  setTimeout(() => {

    visualbeep.classList.remove("beep");
    console.log("list", visualbeep.classList);
  }, 100);
}
